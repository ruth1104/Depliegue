...
def create_app():
    ...
    from app.routes import apprentice_routes, wachiman_routes, login_routes, equipment_routes, instructor_routes, room_routes, roomLoan_routes, records_routes, recordsIn_route
